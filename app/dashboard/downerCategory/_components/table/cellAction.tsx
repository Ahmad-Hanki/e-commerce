...
import deleteDownerCategory from "../../_actions/deleteDownerCategory";
...
const CellAction = ({ data }: cellActionProps) => {
  ...
  const onDelete = async () => {
    const response = await deleteDownerCategory(id);
    if (response) {
    ...
    toast.error("Kategori baska bir kategori ile  bağlantılı.");
    ...
    <div>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem>
            <Link
              href={"/dashboard/downerCategory/" + id}
